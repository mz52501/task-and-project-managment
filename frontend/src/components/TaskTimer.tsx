...
const TaskTimer = () => {
  ...
  return (
    <div className="flex justify-center gap-4">
      ...
      <div
        className={`bg-gray-800 text-lime-400 font-mono text-lg px-3 py-2 rounded shadow-inner border border-gray-700 text-center transition-all duration-300 ease-out ${
