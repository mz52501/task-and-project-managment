                        ...
                        <div className="bg-white rounded-lg shadow p-4">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between"><span
                                    className="text-gray-600">10:00 AM</span><span
                                    className="font-medium">Team Standup</span></div>
                                <div className="flex justify-between"><span
                                    className="text-gray-600">2:00 PM</span><span
                                    className="font-medium">Project Review</span></div>
                                <div className="flex justify-between"><span
                                    className="text-gray-600">4:30 PM</span><span
                                    className="font-medium">Client Call</span></div>
                            </div>
                        </div>
