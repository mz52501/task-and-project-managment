        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md space-y-6">
                ...
                <div className="text-center">
                    <Link to="/" className="text-3xl font-bold text-blue-900">HyperFlow</Link>
                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    ...
                    <p className="text-md text-center text-gray-700 mb-6">Join HyperFlow and streamline your
                        workflow</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-sm text-gray-700">Confirm
                                Password</label>
                            <div className="relative">
                                <input
                        ...
                        <div className="flex items-start space-x-2">
                            ...
                            <label htmlFor="terms" className="text-sm text-gray-600 leading-5">
                                I agree to the{" "}
                                <Link to="/terms" className="text-blue-600 hover:underline">Terms of
                                    Service</Link> and{" "}
